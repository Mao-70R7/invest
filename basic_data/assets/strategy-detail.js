...
(async () => {
  ...
  function classificationSummary() {
    ...
    const benchmarkWeights = ["基准权益权重", "基准债券权重", "基准货币权重", "广义权益权重", "基准资产大类-商品", "基准资产大类-另类"];
    return `<div class="classification-summary">
      <div class="class-chip-grid">
        ...
        ${classChip("广义权益分档", classificationMap.广义权益分档)}
  ...
  function benchmarkAssetStructure() {
    const metaFields = ["基准权益分档", "广义权益分档", "非权益比较轨道", "正式可比池", "可比池样本资格", "基准映射置信度"];
