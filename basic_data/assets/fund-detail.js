(() => {
  ...
  function buildProfileSections(fundData, enrichment, economicSnapshot) {
    ...
    const businessBenchmark = {
      "基准权益分档": dataFromSources("广义权益分档", rawSources) || dataFromSources("基准权益分档", rawSources),
      "基准风险资产权重_百分比": dataFromSources("广义权益权重_百分比", rawSources),
      "基准权益分档说明": dataFromSources("广义权益分档说明", rawSources) || dataFromSources("广义权益口径说明", rawSources),
    };
